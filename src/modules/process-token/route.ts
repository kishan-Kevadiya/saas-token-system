...
import printSettings from './print-settings/print-settings.route';
...
processTokenRoutes.use(
  '/departments',
  validateProcessTokenAuthUser,
  departments
);
processTokenRoutes.use('/print-settings', validateProcessTokenAuthUser, printSettings);
